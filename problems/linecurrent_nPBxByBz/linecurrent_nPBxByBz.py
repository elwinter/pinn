...
NOTE: This version of the code solves *only* the equations for n, P, Bx, By,
and Bz.
...
dependent variables:
    ...
    0: n (number density)
    1: P (pressure)
    2: Bx (x-component of magnetic field)
    3: By (y-component of magnetic field)
    4: Bz (z-component of magnetic field)
...
dependent_variable_names = ['n', 'P', 'Bx', 'By', 'Bz']

# Labels for dependent variables (may use LaTex) - use for plots.
dependent_variable_labels = ["$n$", "$P$", "$B_x$", "$B_y$", "$B_z$"]
...
#     (n, P, Bx, By, Bz) = Y
#     (del_n, del_P, del_Bx, del_By, del_Bz) = del_Y
