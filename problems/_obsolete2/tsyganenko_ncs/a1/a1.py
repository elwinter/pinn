"""Problem definition file for a1.

This file describes Equation (7) for a1 from:
...
ia1 = dependent_variable_index['a1']
...
# this namespace.
a1_empirical = tncs.a1_empirical
