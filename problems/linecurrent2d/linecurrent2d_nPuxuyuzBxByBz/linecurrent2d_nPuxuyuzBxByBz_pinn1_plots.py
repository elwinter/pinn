...
"""Create plots for pinn1 results for linecurrent2d_nPuxuyuzBxByBz problem.
...
# Program description
DESCRIPTION = "Create plots for pinn1 results for linecurrent2d_nPuxuyuzBxByBz problem."

# Name of directory to hold output plots
OUTPUT_DIR = "pinn1_plots"

# Name of problem
PROBLEM_NAME = "linecurrent2d_nPuxuyuzBxByBz"
