...
"""Create data for lagaris04 problem.

This is for problem 4 from Lagaris (1998).
...
# Program description.
description = "Create data for lagaris04 problem."
...
def main():
    ...
    Y1 = p.Y1_analytical(x)
    Y2 = p.Y2_analytical(x)
