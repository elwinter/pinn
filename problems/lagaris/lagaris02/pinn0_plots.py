...
"""Create plots for pinn0 results for lagaris02 problem.
...
# Program description
DESCRIPTION = "Create plots for pinn0 results for lagaris02 problem."

# Name of problem
PROBLEM_NAME = "lagaris02"

# Name of directory to hold output plots
OUTPUT_DIR = f"{PROBLEM_NAME}-pinn0_plots"
...
def pinn0_plots(args: dict):
    """Make standard pinn0 plots for lagaris02.
