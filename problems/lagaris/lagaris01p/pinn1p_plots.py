...
"""Create plots for pinn1 results for  lagaris01p problem.
...
# Program description
DESCRIPTION = "Create plots for pinn1 results for  lagaris01p problem."

# Name of problem
PROBLEM_NAME = "lagaris01p"

# Name of directory to hold output plots
OUTPUT_DIR = f"{PROBLEM_NAME}-ppinn1_plots"
...
def pinn1_plots(args: dict):
    """Make standard pinn1 plots for  lagaris01p.
