...
This version add an artificial viscosity term to the momentum equation to
improve handling of the shock.
...
def pde_n(X, Y, del_Y, del2_Y):
    ...
    del2_Y : list of n_var tf.Tensor, each shape (n, n_dim)
        Values of 2nd-order derivatives of dependent variables wrt independent
