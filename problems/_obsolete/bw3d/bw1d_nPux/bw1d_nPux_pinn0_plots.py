...
"""Create plots for pinn0 results for bw1d_nPux problem.
...
import pinn.common
import pinn.training_data


# Program constants

# Program description
DESCRIPTION = "Create plots for pinn0 results for bw1d_nPux problem."
...
def main():
    ...
    ng = [nt, nx]
    bg = [[0.0, 1.0], [-1.0, 1.0]]
    X_train = pinn.training_data.create_training_points_gridded(ng, bg)
