...
"""Compute data for the bw2d_nPuxuy problem.

This problem is a 2-D blast wave, described with n, P, ux, uy.
...
# Program description.
description = "Compute data for the bw2d_nPuxuy problem."
