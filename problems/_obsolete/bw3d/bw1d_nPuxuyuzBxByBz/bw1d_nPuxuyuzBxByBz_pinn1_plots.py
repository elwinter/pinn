...
"""Create plots for pinn1 results for bw1d_nPuxuyuzBxByBz problem.
...
# Program description
DESCRIPTION = "Create plots for pinn1 results for bw1d_nPuxuyuzBxByBz problem."

# Name of directory to hold output plots
OUTPUT_DIR = "pinn1_plots"

# Name of problem
PROBLEM_NAME = "bw1d_nPuxuyuzBxByBz"
...
def main():
    ...
    # Make a movie of the y-velocity evolution.
    v = p.dependent_variable_names[p.iuy]
    xlabel = p.independent_variable_names[p.ix]
    ylabel = p.dependent_variable_labels[p.iuy]
    ...
    # Make a movie of the z-velocity evolution.
    v = p.dependent_variable_names[p.iuz]
    xlabel = p.independent_variable_names[p.ix]
    ylabel = p.dependent_variable_labels[p.iuz]
    ...
    xlabel = p.independent_variable_names[p.ix]
    ylabel = p.dependent_variable_labels[p.iBy]
    ...
    # Make a movie of the z-magnetic field evolution.
    v = p.dependent_variable_names[p.iBz]
    xlabel = p.independent_variable_names[p.ix]
    ylabel = p.dependent_variable_labels[p.iBz]
