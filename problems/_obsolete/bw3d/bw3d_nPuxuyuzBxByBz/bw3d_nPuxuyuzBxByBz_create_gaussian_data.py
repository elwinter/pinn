...
"""Create data for the bw3d_nPuxuyuzBxByBz problem.

This problem is a 3-D blast wave, described with n, P, ux, uy, uz, Bx, By, Bz.
...
# Program description.
description = "Create data for the bw3d_nPuxuyuzBxByBz problem."
...
def main():
    ...
    # Create the (t, x, y, z) grid points for the data.
