"""Problem definition file for a 1-D MHD blast (pressure) wave, B=0.

This problem definition file describes a 1-D blast (pressure) wave with B = 0,
and only solves the equations for n, P, and ux. This problem is based on the
2-D blast wave example in the Athena MHD test suite. Details are available at:
