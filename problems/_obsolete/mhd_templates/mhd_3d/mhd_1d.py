"""Template for a definition file for a 1-D MHD problem.

This template problem definition file provides the 3-D forms of all 8
standard MHD equations. No linearizations are performed. All values of y and
z, and derivatives with respect to y and z, are defined as 0, but y- and
z-components uy, uz, By and Bz are *not* defined as 0.
