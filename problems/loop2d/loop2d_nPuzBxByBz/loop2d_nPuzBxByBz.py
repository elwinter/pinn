...
NOTE: This version of the code solves *only* the equations for n, P, uz, Bx,
By, and Bz.
...
dependent_variable_names = ["n", "P", "uz", "Bx", "By", "Bz"]
...
def pde_uz(X, Y, del_Y):
    ...
    # G is a Tensor of shape (n, 1).
    G = (
        n*(duz_dt + u0x*duz_dx + u0y*duz_dy) -
...
def pde_Bz(X, Y, del_Y):
    ...
    # G is a Tensor of shape (n, 1).
    G = dBz_dt + u0x*dBz_dx + u0y*dBz_dy - (Bx*duz_dx + By*duz_dy)
    return G
