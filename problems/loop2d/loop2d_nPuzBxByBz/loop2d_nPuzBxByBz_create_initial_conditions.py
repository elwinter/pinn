...
"""Compute initial conditions for loop2d_nPuzBxByBz.
...
# Program description.
description = "Compute initial conditions for loop2d_nPuzBxByBz problem."
    ...
    for x in xg:
        for y in yg:
            ...
            if r < R0:
                ...
                By = B0y
            Bz = B0z
            print(t_min, x, y, n, P, uz, Bx, By, Bz)
