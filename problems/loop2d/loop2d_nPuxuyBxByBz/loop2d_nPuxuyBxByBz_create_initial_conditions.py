...
"""Compute initial conditions for loop2d_nPuxuyBxByBz.
...
# Program description.
description = "Compute data for loop2d_nPuxuyBxByBz problem."
    ...
    for (i, x) in enumerate(xg):
        for (j, y) in enumerate(yg):
            ...
            if r < R0:
                ...
                By = 0.0
            Bz = 0.0
            print(t_min, x, y, n, P, ux, uy, Bx, By, Bz)
