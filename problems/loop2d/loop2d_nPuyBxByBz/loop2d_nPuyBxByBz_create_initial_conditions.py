...
"""Compute initial conditions for loop2d_nPuyBxByBz.
...
# Program description.
description = "Compute initial conditions for loop2d_nPuyBxByBz problem."
    ...
    for x in xg:
        for y in yg:
            ...
            if r < R0:
                ...
                By = B0y
            Bz = B0z
            print(tg[0], x, y, n, P, uy, Bx, By, Bz)
