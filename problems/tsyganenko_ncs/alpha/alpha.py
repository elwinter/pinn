"""Problem definition file for alpha.

This file describes Equation (8) for alpha from:
...
dependent_variable_names = ['alpha']
...
dependent_variable_labels = [r"$\alpha$"]
...
# this namespace.
alpha_empirical = tncs.alpha_empirical
...
if __name__ == '__main__':
    ...
    for i in range(n):
        print(f"{i} {fP[i]} {fBz[i]} {phi[i]} {alpha[i]}")
