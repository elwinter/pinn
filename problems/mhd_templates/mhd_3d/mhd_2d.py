"""Template for a definition file for a 2-D MHD problem.

This template problem definition file provides the 3-D forms of all 8
standard MHD equations. No linearizations are performed. All values of z
and derivatives with respect to z are defined as 0, but z-components uz and
Bz are *not* defined as 0.
