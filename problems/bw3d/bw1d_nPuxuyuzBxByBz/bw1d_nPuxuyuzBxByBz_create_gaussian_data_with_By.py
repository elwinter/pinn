...
"""Create Gaussian data for the bw1d_nPuxuyuzBxByB problem.
...
# Program description.
description = "Create Gaussian data for the bw1d_nPuxuyuzBxByBz problem."
...
B0y = 0.1        # y-component of magnetic field at start
