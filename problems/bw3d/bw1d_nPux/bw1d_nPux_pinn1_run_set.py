...
"""Train a set of models for the bw1d_nPux problem.
...
# Program description
DESCRIPTION = "Train a set of models for the bw1d_nPux problem."
...
SCRIPT_TEMPLATE = os.path.join(
    ...
    "problems", "bw3d", "bw1d_nPux", "bw1d_nPux_pinn1_template.pbs"
)
...
options["data"] = os.path.join(
    os.environ["PINN_INSTALL_DIR"],
    "problems", "bw3d", "bw1d_nPux", "data", "bw1d_nPux_101_201_data.dat"
)
...
options["problem_path"] = os.path.join(
    os.environ["PINN_INSTALL_DIR"],
    "problems", "bw3d", "bw1d_nPux", "bw1d_nPux.py"
)
options["training_points"] = os.path.join(
    os.environ["PINN_INSTALL_DIR"],
    "problems", "bw3d", "bw1d_nPux", "data",
    "bw1d_nPux_101_201_training_grid.dat"
)
